...
# Usage
Before training and conversion, please first add the proper path like `/include/vchsm` in your IDE's header file search path such that `train_C.h` and `convert_C.h` can be found.
## Training
